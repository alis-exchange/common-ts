...
import * as google_api_auth_pb from '../../google/api/auth_pb'; // proto import: "google/api/auth.proto"
import * as google_api_backend_pb from '../../google/api/backend_pb'; // proto import: "google/api/backend.proto"
import * as google_api_billing_pb from '../../google/api/billing_pb'; // proto import: "google/api/billing.proto"
import * as google_api_client_pb from '../../google/api/client_pb'; // proto import: "google/api/client.proto"
import * as google_api_context_pb from '../../google/api/context_pb'; // proto import: "google/api/context.proto"
import * as google_api_control_pb from '../../google/api/control_pb'; // proto import: "google/api/control.proto"
import * as google_api_documentation_pb from '../../google/api/documentation_pb'; // proto import: "google/api/documentation.proto"
import * as google_api_endpoint_pb from '../../google/api/endpoint_pb'; // proto import: "google/api/endpoint.proto"
import * as google_api_http_pb from '../../google/api/http_pb'; // proto import: "google/api/http.proto"
import * as google_api_log_pb from '../../google/api/log_pb'; // proto import: "google/api/log.proto"
import * as google_api_logging_pb from '../../google/api/logging_pb'; // proto import: "google/api/logging.proto"
import * as google_api_metric_pb from '../../google/api/metric_pb'; // proto import: "google/api/metric.proto"
...
import * as google_api_monitoring_pb from '../../google/api/monitoring_pb'; // proto import: "google/api/monitoring.proto"
import * as google_api_quota_pb from '../../google/api/quota_pb'; // proto import: "google/api/quota.proto"
import * as google_api_source_info_pb from '../../google/api/source_info_pb'; // proto import: "google/api/source_info.proto"
import * as google_api_system_parameter_pb from '../../google/api/system_parameter_pb'; // proto import: "google/api/system_parameter.proto"
import * as google_api_usage_pb from '../../google/api/usage_pb'; // proto import: "google/api/usage.proto"
import * as google_protobuf_api_pb from 'google-protobuf/google/protobuf/api_pb'; // proto import: "google/protobuf/api.proto"
