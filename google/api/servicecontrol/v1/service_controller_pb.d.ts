...
import * as google_api_servicecontrol_v1_check_error_pb from '../../../../google/api/servicecontrol/v1/check_error_pb'; // proto import: "google/api/servicecontrol/v1/check_error.proto"
import * as google_api_servicecontrol_v1_operation_pb from '../../../../google/api/servicecontrol/v1/operation_pb'; // proto import: "google/api/servicecontrol/v1/operation.proto"
...
export class CheckResponse extends jspb.Message {
  ...
  setServiceRolloutId(value: string): CheckResponse;
...
export namespace CheckResponse {
  ...
  export class CheckInfo extends jspb.Message {
    ...
    setUnusedArgumentsList(value: Array<string>): CheckInfo;
    clearUnusedArgumentsList(): CheckInfo;
    addUnusedArguments(value: string, index?: number): CheckInfo;
  ...
  export class ConsumerInfo extends jspb.Message {
    ...
    getType(): CheckResponse.ConsumerInfo.ConsumerType;
    setType(value: CheckResponse.ConsumerInfo.ConsumerType): ConsumerInfo;

    getConsumerNumber(): number;
    setConsumerNumber(value: number): ConsumerInfo;
...
export class ReportResponse extends jspb.Message {
  ...
  getServiceRolloutId(): string;
  setServiceRolloutId(value: string): ReportResponse;
