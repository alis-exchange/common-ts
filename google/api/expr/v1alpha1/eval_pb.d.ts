...
import * as google_api_expr_v1alpha1_value_pb from '../../../../google/api/expr/v1alpha1/value_pb'; // proto import: "google/api/expr/v1alpha1/value.proto"
...
export class ExprValue extends jspb.Message {
  ...
  setValue(value?: google_api_expr_v1alpha1_value_pb.Value): ExprValue;
  hasValue(): boolean;
...
export class UnknownSet extends jspb.Message {
  ...
  setExprsList(value: Array<number>): UnknownSet;
  clearExprsList(): UnknownSet;
  addExprs(value: number, index?: number): UnknownSet;
