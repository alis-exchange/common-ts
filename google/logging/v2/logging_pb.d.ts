...
export class ListLogsRequest extends jspb.Message {
  ...
  getResourceNamesList(): Array<string>;
  setResourceNamesList(value: Array<string>): ListLogsRequest;
  clearResourceNamesList(): ListLogsRequest;
  addResourceNames(value: string, index?: number): ListLogsRequest;
...
export class TailLogEntriesRequest extends jspb.Message {
  getResourceNamesList(): Array<string>;
  setResourceNamesList(value: Array<string>): TailLogEntriesRequest;
  clearResourceNamesList(): TailLogEntriesRequest;
  addResourceNames(value: string, index?: number): TailLogEntriesRequest;

  getFilter(): string;
  setFilter(value: string): TailLogEntriesRequest;

  getBufferWindow(): google_protobuf_duration_pb.Duration | undefined;
  setBufferWindow(value?: google_protobuf_duration_pb.Duration): TailLogEntriesRequest;
  hasBufferWindow(): boolean;
  clearBufferWindow(): TailLogEntriesRequest;
...
export class TailLogEntriesResponse extends jspb.Message {
  getEntriesList(): Array<google_logging_v2_log_entry_pb.LogEntry>;
  setEntriesList(value: Array<google_logging_v2_log_entry_pb.LogEntry>): TailLogEntriesResponse;
  clearEntriesList(): TailLogEntriesResponse;
  addEntries(value?: google_logging_v2_log_entry_pb.LogEntry, index?: number): google_logging_v2_log_entry_pb.LogEntry;

  getSuppressionInfoList(): Array<TailLogEntriesResponse.SuppressionInfo>;
  setSuppressionInfoList(value: Array<TailLogEntriesResponse.SuppressionInfo>): TailLogEntriesResponse;
  clearSuppressionInfoList(): TailLogEntriesResponse;
...
export namespace TailLogEntriesResponse {
  ...
  export class SuppressionInfo extends jspb.Message {
    getReason(): TailLogEntriesResponse.SuppressionInfo.Reason;
    setReason(value: TailLogEntriesResponse.SuppressionInfo.Reason): SuppressionInfo;

    getSuppressedCount(): number;
    setSuppressedCount(value: number): SuppressionInfo;
