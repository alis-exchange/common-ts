...
import * as google_api_distribution_pb from '../../../google/api/distribution_pb'; // proto import: "google/api/distribution.proto"
...
export class LogMetric extends jspb.Message {
  ...
  getDisabled(): boolean;
  setDisabled(value: boolean): LogMetric;
  ...
  setCreateTime(value?: google_protobuf_timestamp_pb.Timestamp): LogMetric;
  hasCreateTime(): boolean;
  clearCreateTime(): LogMetric;

  getUpdateTime(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setUpdateTime(value?: google_protobuf_timestamp_pb.Timestamp): LogMetric;
  hasUpdateTime(): boolean;
  clearUpdateTime(): LogMetric;
