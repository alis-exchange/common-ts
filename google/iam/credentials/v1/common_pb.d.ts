...
export class GenerateAccessTokenRequest extends jspb.Message {
  ...
  clearDelegatesList(): GenerateAccessTokenRequest;
  addDelegates(value: string, index?: number): GenerateAccessTokenRequest;

  getScopeList(): Array<string>;
  setScopeList(value: Array<string>): GenerateAccessTokenRequest;
  clearScopeList(): GenerateAccessTokenRequest;
  addScope(value: string, index?: number): GenerateAccessTokenRequest;
  ...
  hasLifetime(): boolean;
  clearLifetime(): GenerateAccessTokenRequest;
...
export class GenerateAccessTokenResponse extends jspb.Message {
  ...
  clearExpireTime(): GenerateAccessTokenResponse;
...
export class SignBlobRequest extends jspb.Message {
  ...
  clearDelegatesList(): SignBlobRequest;
  addDelegates(value: string, index?: number): SignBlobRequest;
...
export class SignJwtRequest extends jspb.Message {
  ...
  clearDelegatesList(): SignJwtRequest;
  addDelegates(value: string, index?: number): SignJwtRequest;
...
export class GenerateIdTokenRequest extends jspb.Message {
  ...
  clearDelegatesList(): GenerateIdTokenRequest;
  addDelegates(value: string, index?: number): GenerateIdTokenRequest;
