...
import * as google_iam_v2beta_deny_pb from '../../../google/iam/v2beta/deny_pb'; // proto import: "google/iam/v2beta/deny.proto"
...
export class PolicyRule extends jspb.Message {
  getDenyRule(): google_iam_v2beta_deny_pb.DenyRule | undefined;
  setDenyRule(value?: google_iam_v2beta_deny_pb.DenyRule): PolicyRule;
  hasDenyRule(): boolean;
...
export namespace PolicyRule {
  export type AsObject = {
    denyRule?: google_iam_v2beta_deny_pb.DenyRule.AsObject,
    description: string,
  }
